...
public class NotaFiscalCompraService {
	...
	public List<ObjetoRelatorioStatusCompra> relatorioStatusVendaLojaVirtual(
	 ...
	 * 
	 * Este relatório permite saber os produtos comprados para serem vendido pela
	 * loja virtual, todos os produtos tem relação com a nota fiscal de
	 * compra/venda.
	 * 
	 * @param obejtoRequisicaoRelatorioProdCompraNotaFiscalDto
	 * @param dataInicio                                       e dataFinal são
	 *                                                         parametros
	 *                                                         obrigatórios
