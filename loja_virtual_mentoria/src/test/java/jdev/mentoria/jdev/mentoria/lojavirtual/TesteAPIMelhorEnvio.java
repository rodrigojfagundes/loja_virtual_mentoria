...
public class TesteAPIMelhorEnvio {
	...
	public static void main(String[] args) throws Exception {
		...
		Request request = new Request.Builder()
				.url(ApiTokenIntegracao.URL_MELHOR_ENVIO_SAND_BOX + "api/v2/me/shipment/tracking").method("POST", body)
		...
		// MediaType mediaType = MediaType.parse("application/json");
		// RequestBody body = RequestBody.create(mediaType,
		// "{\"mode\":\"private\",\"orders\":[\"9e55f440-38c6-4491-8884-18dae893ae58\"]}");
		// Request request = new Request.Builder()
		// .url("https://sandbox.melhorenvio.com.br/api/v2/me/shipment/print")
		// .post(body)
		// .addHeader("Accept", "application/json")
		// .addHeader("Content-Type", "application/json")
		// .addHeader("Authorization", "Bearer_Token_Melhor_Envio")
		// .addHeader("User-Agent", "rodrigojosefagundes@gmail.com")
		// .build();
		...
		// MediaType mediaType = MediaType.parse("application/json");
		// RequestBody body = RequestBody.create(mediaType,
		// "{\"orders\":[\"9e55f440-38c6-4491-8884-18dae893ae58\"]}");
		// Request request = new Request.Builder()
